...
type Trip={id:string;trace_code:string;plantation_folio:string|null;plantation_trip_number:number|null;origin_farm_id:string|null;driver_id:string|null;status:string;destination_name:string|null;departed_at:string|null;arrived_at:string|null;delivered_at?:string|null;vehicle_plate?:string|null};
...
export default function RealApp(){
 ...
 const load=useCallback(async()=>{if(!supabase||!session)return;setError('');try{
  ...
  const [f,c,h,l,t,tl,d,w,hp,dp,dr]=await Promise.all([
   ...
   supabase.from('trips').select('id,trace_code,plantation_folio,plantation_trip_number,origin_farm_id,driver_id,status,destination_name,departed_at,arrived_at,delivered_at,vehicle_plate').eq('organization_id',org).order('created_at',{ascending:false}),
