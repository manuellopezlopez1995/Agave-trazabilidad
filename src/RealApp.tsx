...
export default function RealApp(){
 ...
 const addPhoto=(kind:'harvest'|'delivery',id:string)=>action(async()=>{
  ...
  if(photo.queued){setPendingCount((await pendingEvidence()).length);showError('Fotografía guardada sólo en este dispositivo. Sincronízala antes de cerrar el registro o borrar los datos del navegador.');return}
  if(kind==='harvest'){
